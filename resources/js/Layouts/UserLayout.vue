                            ...
                            <div class="ml-3 relative">
                                <div class="flex items-center space-x-3 relative">
                                    <Link v-if="$page.props.user" :href="route('dashboard')"
                                          class="text-sm text-lime-700 dark:text-lime-500 underline">
                                        Dashboard
                                    </Link>
                                    <template v-else>
                                        <Link :href="route('login')" class="text-sm text-lime-700 dark:text-lime-500 underline">
                                            Log in
                                        </Link>

                                        <Link v-if="canRegister" :href="route('register')" class="ml-4 text-sm text-lime-700 dark:text-lime-500 underline">
                                            Register
                                        </Link>
                                    </template>
